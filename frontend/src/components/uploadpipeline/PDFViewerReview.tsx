            ...
            {selectedPdf && (
              <Box
                sx={(theme) => ({
                  ...
                  minHeight: 0,
                  borderRadius: 3,
                  bgcolor: theme.palette.mode === 'dark' ? '#0f1014' : '#f0f0f0',
                  border: '1px solid',
                  borderColor: 'divider',
                  overflow: 'hidden',
                  display: 'flex',
              ...
              >
                ...
                >
                  <Document
                    ...
                    loading={
                      <Typography sx={{ color: 'text.secondary', py: 6 }}>
                        PDF wird geladen …
                      </Typography>
                    }
                    error={
                      <Typography sx={{ color: 'error.main', py: 6 }}>
  ...
  return (
    ...
    >
      <CloudUploadOutlinedIcon
        sx={{ fontSize: 72, color: isDragging ? 'primary.main' : 'text.secondary', mb: 2 }}
      />
